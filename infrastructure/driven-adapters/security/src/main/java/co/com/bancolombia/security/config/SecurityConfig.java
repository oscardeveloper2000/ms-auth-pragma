...
public class SecurityConfig {
  ...
  public SecurityWebFilterChain filterChain(ServerHttpSecurity http,
      ...
      return http.csrf(ServerHttpSecurity.CsrfSpec::disable)
              .authorizeExchange(exchange -> exchange.pathMatchers("/api/v1/login", "/swagger-ui.html", "/swagger-ui/", "/v3/api-docs/**", "/webjars/swagger-ui/**","/openapi/**", "/actuator/health")
                      .permitAll()
                      ...
                      .hasAnyAuthority(RoleCode.ADVISOR.dbName(), RoleCode.ADMIN.dbName())
                      .anyExchange()
                      .authenticated())
